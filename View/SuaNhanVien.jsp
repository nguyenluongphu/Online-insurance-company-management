                           	...
                           	<form action="SuaNhanVienServlet?" id="form" method="POST" class="form-horizontal tasi-form" role = "form">
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group m-b-8">
	                                          ...
	                                          <input type="text" readonly="readonly" class="form-control" value="${nhanVien.getMaNhanVien() }" name="id" required title ="" placeholder="">
	                                      </div>
	                                  </div>
	                                  <span id="error">*</span>
	                              </div>
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group m-b-8">
	                                          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
	                                          <input type="text" class="form-control" value="${nhanVien.getHoTen() }" name="txtHoTen" required title ="Xin vui lòng nhập Họ Tên!" placeholder="Nhập tên ở đây!">
	                                      </div>
	                                  </div>
	                                  <span id="error">*</span>
	                              </div>
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group m-b-8">
	                                          ...
	                                          <input type="Date" class="form-control" value="${nhanVien.getNgaySinh() }" name="txtNgaySinh" required title ="Xin vui lòng nhập vị trí!" placeholder="Chọn ngày sinh!">
	                                      </div>
	                                  </div>
	                                  <span id="error">*</span>
	                              </div>
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group">
	                                      		<c:if test="${nhanVien.getGioiTinh() == 'Nam' }">
	                                      		...
	                                      		<c:if test="${nhanVien.getGioiTinh() != 'Nam' }">
	                                      			<label class="radio-inline"><input type="radio" name="rdGioiTinh" value= "Nam">Nam</label>
	                                      			<label class="radio-inline"><input type="radio" checked="checked" name="rdGioiTinh" value="Nữ">Nữ</label>
	                                      		</c:if>
	                                      </div>
	                                  </div>
	                                  <span id="error">*</span>
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group m-b-8">
	                                          ...
	                                          <input type="text" class="form-control" value="${nhanVien.getSoDienThoai() }" id ="txtSDT" name="txtSDT" required title ="Xin vui lòng nhập số điện thoại!" placeholder="Nhập số điện thoại">
	                                      </div>
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group m-b-8">
	                                          ...
	                                          <input type="email" class="form-control" value="${nhanVien.getEmail() }" id="txtEmail" name="txtEmail" required title ="Xin vui lòng nhập email!" placeholder="Nhập email">
	                                      </div>
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group m-b-8">
	                                          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
	                                          <input type="text" class="form-control" value="${nhanVien.getCmnd() }" id="txtCMND" name="txtCMND" required title ="Xin vui lòng nhập CMND!" placeholder="Nhập CMND!">
	                                      </div>
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group m-b-8">
	                                          ...
	                                          <input type="text" class="form-control" value="${nhanVien.getDiaChi() }" name="txtDiaChi" required title ="Xin vui lòng nhập địa chỉ!" placeholder="Nhập địa chỉ">
	                                      </div>
	                                  </div>
	                                  <span id="error">*</span>
	                              </div>
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group m-b-8">
	                                          ...
	                                          <input type="text" class="form-control" value="${nhanVien.getSoTaiKhoan() }" id="txtSoTaiKhoan" name="txtSoTaiKhoan" required title ="Xin vui lòng nhập số tài khoản!" placeholder="Nhập số tài khoản">
	                                      </div>
	                              ...
	                              <div class="form-group">
	                                  ...
	                                  <div class="col-lg-8">
	                                      <div class="input-group m-b-8">
	                                          ...
	                                          <input type="text" class="form-control" value="${nhanVien.getNganHang() }" name="txtNganHang" required title ="Xin vui lòng nhập ngân hàng!" placeholder="nhập ngân hàng">
	                                      </div>
	                                  </div>
	                              </div>
	                                  	...
	                                  	<div class="input-group m-b-8">
		                                     ...
		                                     <select class="form-control" name="cbMaChucVu">
		                                     	<c:forEach items="${dsChucVu }" var = "cv">
		                                     		<c:if test ="${nhanVien.getMaChucVu() == cv.getMaChucVu()}">
		                                     			<option value='${cv.getMaChucVu()}' selected="selected">${cv.getTenChucVu()}</option>
		                                     		</c:if>
		                                     		<c:if test ="${nhanVien.getMaChucVu() != cv.getMaChucVu()}">
	                              ...
	                              <div class="form-group"> 
       							    <div class="col-sm-offset-3 col-sm-9">
       							      <button type="submit" id ="btnSubmit" onclick="return checkvalidate()" class="btn btn-success"><span><i class="glyphicon glyphicon-upload"></i></span> Cập Nhật</button>
