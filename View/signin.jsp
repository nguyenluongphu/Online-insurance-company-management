...
<!-- Default-JavaScript --><script src="js/jquery-2.2.3.js"></script>
     ...
     <script type="text/javascript">
            ...
            function validateConfirmPassword() {
                ...
                if (a == b) {
                	if(b == ''){
                		   document.getElementById("errorConfirmPassword").innerHTML="Vui lòng nhập xác nhận mật khẩu !";
                           return false;
                	}else{
                    ...
                    document.getElementById("errorConfirmPassword").innerHTML="Xác nhận mật khẩu không chính xác !";
                    return false;
                }
            }
...
<%
        ...
        String tenDangNhapError = "";
        if(request.getAttribute("tenDangNhapError") != null){
            tenDangNhapError = (String)request.getAttribute("tenDangNhapError");
        }
        String tk = null;
    ...
    <div class="wthreeaddressaits">
        <div class="container">
            ...
            <div class="col-md-4 wthreeaddressaits-grid wthreeaddressaits-grid2 email-form">
                <h2 style="margin: -50px 0 50px; font-weight: bold;">ĐĂNG KÝ</h2>
                <form action="TaiKhoanServlet" method="post">
                <div style="float: left; width: 95%">
                    <span style="color: red" id="errorName"></span> 
                    <input id="Name" type="text" class="text" name="Name" placeholder="Họ tên" value="">
                </div>
                ...
                <div style="float: left; width: 95%">
                    ...
                    <input id="Address" type="text" class="text" name="Address" placeholder="Địa chỉ"  value="">
                </div>
                <div style="float: right; width: 5%">
                	<span style="color: red; float: right; font-size: 20px;margin-top: 8px">*</span> 
                </div>    
                <div style="float: left; width: 95%">
                    ...
                    <input id="Phone" type="text" class="text" name="Phone" placeholder="Số điện thoại" value="">
                </div>
                <div style="float: right; width: 5%">
                	<span style="color: red; float: right; font-size: 20px;margin-top: 8px">*</span> 
                </div>   
               	<div style="float: left; width: 95%">
                    <span style="color: red" id="errorEmail"><%=tenDangNhapError %></span> 
                    <input id="Email" type="text" class="text" name="Email" placeholder="Email" value="">
                 </div>
                <div style="float: right; width: 5%">
                	<span style="color: red; float: right; font-size: 20px;margin-top: 8px">*</span> 
                </div> 
                ...
                <div style="float: right; width: 5%">
                    ...
                    <%-- <input type="text" class="text" name="BankName" placeholder="Tên ngân hàng (Không bắt buộc)" value="<%=bankName %>" >
                    <input type="text" class="text" name="AccountNumber" placeholder="Số tài khoản (Không bắt buộc)" value="<%=accountNumber %>"> --%>
                    <input type="hidden" value="signin" name="type">
                <div style="float: left; width: 95%">
                    <input type="submit" value="Đăng ký" onclick="return CheckValidate()">
                </div>
                </form>
            </div>
