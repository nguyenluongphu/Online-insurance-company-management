                        ...
                        <div class="col-md-12">
                          ...
                          <section class="panel tasks-widget">
                            <header class="panel-heading">
                                  <h4 id="tieude"><strong>Danh Sách Hồ Sơ Khách Hàng</strong></h4>
                                  <div id="timkiem">
								      ...
								      <c:forEach items="${dsHoSo }" var = "hs">
								        ...
								        <td class="col-sm-2" style="padding-left: 0px; ">
								        	<div class="pull-right hidden-phone">
								        		...
								        		<c:if test="${hs.getMaNhanVien() != null}">
								        			<button class="btn btn-default btn-xs" onclick="xacThuc('${hs.getMaHoSo()}')">${hs.getTrangThaiXacThuc()}</button>
								        		</c:if>
								        		<!-- <button class="btn btn-danger btn-xs" onclick="giamDinh('${hs.getMaHoSo()}')">${hs.getTrangThaiXacThuc()}</button> -->
                          ...
                          <div class="col-sm-12" style="text-align: center; max-width: 100%;">
						 	<ul class = "pagination">
							 	<c:if test="${numberpage > 1}">
							 		<li><a href = "QuanLyHoSoServlet?pageid=1">&laquo;</a></li>
							 	</c:if>
						 		<c:if test="${sumpage < 2}">
							   	...
							   	<c:if test="${sumpage >= 3}">
							   		<c:if test="${numberpage > 1}">
							   			<li><a href = "QuanLyHoSoServlet?pageid=${numberpage-1}">${numberpage-1}</a></li>
							   		</c:if>
							   		<li><a href = "QuanLyHoSoServlet?pageid=${numberpage+1}">${numberpage+1}</a></li>
						  	 		<li><a href = "QuanLyHoSoServlet?pageid=${numberpage+3}">${numberpage+3}</a></li>
							   	</c:if>
