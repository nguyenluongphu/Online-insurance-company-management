		 ...
		 <aside class="right-side">
            ...
            <section class="content">
            	<div class="row" style="margin-bottom:5px;">
                        ...
                        <div class="col-md-3">
                            <div class="sm-st clearfix">
                                <span class="sm-st-icon st-blue"><i class="fa fa-female"></i></span>
                                <div class="sm-st-info">
                                    <span>${soLuongNu }</span>
                                    Nhân Viên Nữ
                                </div>
                          ...
                          <div class="col-sm-12" style="text-align: center; max-width: 100%;">
						 	<ul class = "pagination">
							 	<c:if test="${numberpage > 1}">
							 		<li><a href = "AdminServlet?pageid=1">&laquo;</a></li>
							 	</c:if>
						 		<c:if test="${sumpage < 2}">
						 			<li><a href = "AdminServlet?pageid=1">1</a></li>
						 		</c:if>
							   	<c:if test="${sumpage < 3}">
							   		<li><a href = "AdminServlet?pageid=2">2</a></li>
							   	</c:if>
							   	<c:if test="${sumpage >= 3}">
							   		<c:if test="${numberpage > 1}">
							   			<li><a href = "AdminServlet?pageid=${numberpage-1}">${numberpage-1}</a></li>
							   		</c:if>
							   		<li><a href = "AdminServlet?pageid=${numberpage+1}">${numberpage+1}</a></li>
						  	 		<li><a href = "AdminServlet?pageid=${numberpage+3}">${numberpage+3}</a></li>
							   	</c:if>
						  	 	
							   	<c:if test="${numberpage < sumpage }">
							   		<li><a href = "AdminServlet?pageid=${sumpage}">&raquo;</a></li>
							   	</c:if>
